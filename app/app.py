import pygame
from interface import RunMode, Ui, LobbyUi, MpGameUi
...
class LeApp:
    ...
    def ui_transition(self):
        if self.active_ui.switch_mode:
            self._ui_transition_map[(self.mode, self.active_ui.switch_mode)]()
    ...
    def _from_mp_lobby_to_mp_game(self):
        ...
        if not (isinstance(lobby_ui, LobbyUi) and isinstance(mp_game_ui, MpGameUi)):
